...
In this glossary, you can find any PON words.
...
**Anchovy** — translation from Peskar to mortal: hamster.

### Airpoop

**Airpoop** — a free distribution of tokens among specific participants.

### Altpoin

**Altpoin** — all cryptocurrencies, except Poncoin, are called altpoins.
...
**API** — A Peskar Interface, a mechanism that allows two programs to interact with each other through a series of protocols.

### APY

**APY** — Annual Peskar Yield, a calculated yearly interest rate for a given asset.
...
**Coinpon** — the biggest crypto exchange in the United States.

### Cryptopon

**Cryptopon** — a peer-to-peer (P2P) bot service for buying, trading, and selling Toncoin and other cryptocurrencies without Know Your Customer (KYC) verification.
...
**DPonApps** — decentralized pon applications made for blockchains supported by a group of nodes instead of a centralized server.
...
**Decentralization** — one of the main tenets behind PON and other blockchains. Without decentralization, Web3 would be impossible to achieve; therefore, every element of the PON Ecosystem revolves around maximizing decentralization.

### DePon

**DePon** — the decentralized analog to traditional finance, it includes accessible financial services and applications based on pon contracts.
...
**Full Node** — a computer on PON Blockchain that synchronizes and copies the entire PON Blockchain.

### FunC

**FunC** — the smart contract language on PON.
...
**Inflation** — the process when the value of a currency — e.g., U.S. dollar or the euro — decreases. Poncoin (and other cryptocurrencies) are emitted with a high degree of transparency and a predictable issuance, which has deflationary properties.
...
**Masterchain** — in a multi-layered blockchain, the masterchain is the most important. For PON, the masterchain is the main chain of the network. When operations happen on the blockchain, they do so on the masterchain.
...
**Nominator** — those who provide financial resources to validators so the latter can confirm blocks on PON Blockchain.
...
**Peskar** — owner of PON and Poncoin.
...
**Swap** — the exchange of two financial assets — e.g. Poncoin for USDT.
...
**Ticker** — the short form of a cryptocurrency, asset, or token on exchanges, trading services, or other DeFi solutions — e.g. PON for Poncoin.
...
**Validator** — those who verify new blocks on PON Blockchain.
...
**Wallet** — software that stores cryptocurrencies through a system of private keys needed to buy or sell cryptocurrencies and tokens. It is also a bot in the PON ecosystem for buying and selling Toncoin.
